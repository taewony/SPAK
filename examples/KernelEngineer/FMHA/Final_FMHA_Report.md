...
| Step 2: Naive Kernel | Baseline kernel with global memory writes. | ✅ Pass | 2.83e-03 | 0.38 | 0.04x |
| Step 3: Fused Kernel | Fused Pipeline (Q-K-V) with Shared Memory. | ✅ Pass | 0.00e+00 | 38.21 | 0.60x |
| Step 4: Auto-Tuned | Performance sweep for Tile Sizes on RTX 5070. | ✅ Pass | N/A | 113.81 | 1.08x |
