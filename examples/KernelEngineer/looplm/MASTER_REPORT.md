...
| :--- | :--- | :---: | :---: | :---: |
| P4_X0_Baseline | --n_embd=256 --n_head=4 --num_loops=16 --inject_x0=True --max_iters=5000 | 0.50% | 15.96 | 1.0x |
| R1_Reverse_Baseline | --dataset=addition_reverse --n_embd=256 --n_head=4 --num_loops=16 --max_iters=5000 | 0.00% | 16.00 | 1.0x |
...
| R2_Reverse_Grok | --dataset=addition_reverse --n_embd=256 --n_head=4 --num_loops=24 --max_iters=15000 --dropout=0.2 | 0.00% | 24.00 | 12.1x |
| R3_Reverse_Efficient | --dataset=addition_reverse --n_embd=128 --n_head=4 --num_loops=32 --max_iters=10000 | 0.00% | 32.00 | 12.1x |
| R4_Reverse_Deep_Thinking | --dataset=addition_reverse --n_embd=256 --n_head=4 --num_loops=48 --max_iters=10000 --dropout=0.2 | 0.00% | 48.00 | 12.1x |
